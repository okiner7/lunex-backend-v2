...
const { getProxyStats, markProxyFailed, markProxySuccess } = require('../../middleware/proxyManager')
...
async function checkAll() {
  const { getProxyStats, markProxyFailed, markProxySuccess, _pool } = require('../../middleware/proxyManager')
